...
namespace Ts_Core.Services.BigCraftableRelated
{
    ...
    public static class MachineActionEffectService
    {
        ...
        private static void PlayMachineEffects(
            ...
            BigCraftableExtensionData extension)
        {
            if (extension.ActionEffects == null
                || extension.ActionEffects.Count == 0)
            {
                return;
            }
        ...
        private static void PlayActionLight(
            ...
            BigCraftableExtensionData extension)
        {
            if (!extension.ActionLight)
                return;

            if (extension.ActionLightDurationMs <= 0)
                return;
            ...
            DelayedAction.functionAfterDelay(
                ...
                extension.ActionLightDurationMs);
        }
